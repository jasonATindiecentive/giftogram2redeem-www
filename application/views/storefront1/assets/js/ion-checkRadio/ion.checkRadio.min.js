...
(function(e){var k=0,d={init:function(){return this.each(function(){var a=e(this),b,f,d,g,l,m,c,h;if(!a.data("isActive")){a.data("isActive",!0);k++;this.pluginCount=k;l=a.prop("type");d=a.prop("disabled");g=a.prop("checked");m=a.prop("name");b=a.parent("label");if(0<b.length)h=b.php(),c=h.replace(/<input["-=a-zA-Z\u0400-\u04FF\s\d]+>{1}/,""),h=c.trim();else if(b=a.prop("id"),b=e("label[for='"+b+"']"),0<b.length)h=b.php().trim();else throw Error("Label not found!");a[0].style.display="none";b[0].style.display=
